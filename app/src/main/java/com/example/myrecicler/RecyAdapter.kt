...
import com.example.myrecicler.databinding.ListUtilBinding
import java.net.ContentHandler
import java.security.AccessControlContext

class RecyAdapter(private var mData : Array<Nota>, private val context: Context?) : RecyclerView.Adapter<RecyAdapter.Notina>() {
